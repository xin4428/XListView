package com.yujin.adapter;

import android.view.View;
import android.view.ViewGroup;
import android.widget.BaseAdapter;

import com.yujin.impl.SwipeItemMangerImpl;
import com.yujin.interfaces.SwipeAdapterInterface;
import com.yujin.interfaces.SwipeItemMangerInterface;
...
public abstract class BaseSwipeAdapter extends BaseAdapter implements SwipeItemMangerInterface, SwipeAdapterInterface {
	...
	/**
	 * return the {@link com.yujin.swipe.SwipeLayout} resource id, int the view item.
	 *
	 * @param position
	 * @return
	 */
